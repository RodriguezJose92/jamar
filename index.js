...
class MudiExperience{
    ...
    createStyles(){
        ...
        link.href=`https://cdn.jsdelivr.net/gh/RodriguezJose92/jamar@latest/index.css`; /* custom this path */
                ...
                <div class="containerBtnsActions">
                    ...
                    <div id="containerQR" class="containerQRMudi" style="background-color:${this.color}">
                        ...
                        <div class="containerText">
                            ...
                            <div class="titleContainer">
                                <div class="iconTitle">
                                    <img class="stepMudi step1" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/jamar@latest/assets/step3jamar.webp">
                                </div>
                            ...
                            <div class="titleContainer">
                                <div class="iconTitle">
                                    <img class="stepMudi step2" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/jamar@latest/assets/step4jamar.webp">
                                </div>
                            ...
                            <div class="titleContainer">
                                <div class="iconTitle">
                                    <img class="stepMudi step3" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/jamar@latest/assets/step2jamar.webp">
                                </div>
                            ...
                            <div class="titleContainer">
                                <div class="iconTitle">
                                    <img class="stepMudi step4" src="https://cdn.jsdelivr.net/gh/RodriguezJose92/jamar@latest/assets/step1jamar.webp">
                                </div>
...
setTimeout(()=>{mudiExperience.experienceOn( document.body.querySelector('.txt-sku').innerHTML.replace('Código ','').trim() , document.body.querySelector('.carousel-inner').parentNode )},2000)
